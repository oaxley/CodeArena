/**  
 * @file    instructionexecor.cpp
 * @author  Sebastien Legrand
 * @email   oaxley@gmail.com
 * @date    2012-01-03
 *
 * @brief   Implementation / Execute the OR instruction
 */
...
// constructor
 InstructionExecOr::InstructionExecOr( )
{
}

// destructor
/*virtual*/ InstructionExecOr::~InstructionExecOr( )
{
}

// execute the jmp opcode
bool InstructionExecOr::execute(Instruction* pInstr, TaskSet* pTask, Memory* pMemory)
{
