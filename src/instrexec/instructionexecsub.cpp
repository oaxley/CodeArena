/**  
 * @file    instructionexecsub.cpp
 * @author  Sebastien Legrand
 * @email   oaxley@gmail.com
 * @date    2012-01-03
 *
 * @brief   Implementation / Execute the SUB instruction
 */
...
// constructor
 InstructionExecSub::InstructionExecSub( )
{
}

// destructor
/*virtual*/ InstructionExecSub::~InstructionExecSub( )
{
}

// execute the opcode
bool InstructionExecSub::execute(Instruction* pInstr, TaskSet* pTask, Memory* pMemory)
{
