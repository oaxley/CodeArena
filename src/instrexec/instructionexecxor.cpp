/**  
 * @file    instructionexecxor.cpp
 * @author  Sebastien Legrand
 * @email   oaxley@gmail.com
 * @date    2012-01-03
 *
 * @brief   Implementation / Execute the XOR instruction
 */
...
// constructor
 InstructionExecXor::InstructionExecXor( )
{
}

// destructor
/*virtual*/ InstructionExecXor::~InstructionExecXor( )
{
}

// execute the jmp opcode
bool InstructionExecXor::execute(Instruction* pInstr, TaskSet* pTask, Memory* pMemory)
{
