/**  
 * @file    instructionexecmul.cpp
 * @author  Sebastien Legrand
 * @email   oaxley@gmail.com
 * @date    2012-01-03
 *
 * @brief   Implementation / Execute the MUL instruction
 */
...
// constructor
 InstructionExecMul::InstructionExecMul( )
{
}

// destructor
/*virtual*/ InstructionExecMul::~InstructionExecMul( )
{
}

// execute the opcode
bool InstructionExecMul::execute(Instruction* pInstr, TaskSet* pTask, Memory* pMemory)
{
