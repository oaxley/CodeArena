/**  
 * @file    instructionexecadd.cpp
 * @author  Sebastien Legrand
 * @email   oaxley@gmail.com
 * @date    2012-01-03
 *
 * @brief   Implementation / Execute the ADD instruction
 */
...
// constructor
 InstructionExecAdd::InstructionExecAdd( )
{
}

// destructor
/*virtual*/ InstructionExecAdd::~InstructionExecAdd( )
{
}

// execute the opcode
bool InstructionExecAdd::execute(Instruction* pInstr, TaskSet* pTask, Memory* pMemory)
{
